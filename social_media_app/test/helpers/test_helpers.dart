  ...
  when(
    service.showCustomSheet<T, T>(
      ...
      showIconInAdditionalButton:
          anyNamed('showIconInAdditionalButton'),
    ...
    (realInvocation) => Future.value(
        showCustomSheetResponse ?? SheetResponse<T>()),
  );
...
MockSharedPreferenceService
  ...
  locator
      .registerSingleton<SharedPreferenceService>(service);
  return service;
}
